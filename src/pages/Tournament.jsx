...
import '../App.css';
import breadCrumImg03 from '../assets/others/breadcrumb_img03.png'
import tournament_thumb01 from '../assets/others/tournament_thumb01.png'
import tournament_thumb02 from '../assets/others/tournament_thumb02.png'
import tournament_thumb03 from '../assets/others/tournament_thumb03.png'
import thumb01 from '../assets/others/tournament01.jpg'
import thumb02 from '../assets/others/tournament02.jpg'
import thumb03 from '../assets/others/tournament03.jpg'
  ...
  return (
    <>
      <section className='container'>
        <div className='row'>
          <div className="col-xl-6 col-lg-7 tournament-hero">
            <h2 className="title">Tournament</h2>
          </div>
          <div className="col-xl-6 col-lg-5 tournament-hero">
            <img src={breadCrumImg03} alt="img" />
          </div>
        </div>
      </section>
      ...
      <section class="tournament-area section-pt-120 section-pb-90">
        <div class="container">
          <div class="tournament__wrapper">
            ...
            <div class="row justify-content-center gutter-25">
              <div class="col-xl-4 col-lg-5 col-md-6 col-sm-9">
                <div class="tournament__box-wrap">
                  ...
                  <div class="tournament__box-countdown">
                    <div class="coming-time" data-countdown="2023/5/16"></div>
                  </div>
                  ...
                  <ul class="tournament__box-list list-wrap">
                    <li>
                      <div class="tournament__box-list-item">
                        ...
                        <span class="tournament__player-price">$ 75000 <i
                    ...
                    <li>
                      <div class="tournament__box-list-item">
                        ...
                        <span class="tournament__player-price">$ 65000 <i
                          class="fas fa-bolt"></i></span>
                      </div>
                    </li>
                    <li>
                      <div class="tournament__box-list-item">
                        ...
                        <span class="tournament__player-price">$ 55000 <i
                          class="fas fa-bolt"></i></span>
                      </div>
                    </li>
                  </ul>
      ...
      <section class="tournament__list-area section-pb-120 section-pt-120">
        <div class="container">
          <div class="tournament__wrapper">
                ...
                <div class="tournament__list-item-wrapper">
                    ...
                    <div class="tournament__list-content">
                      <div class="tournament__list-thumb">
                        <a href="tournament-details.html">
                          <img src={tournament_thumb01} alt="img" />
                        </a>
                      </div>
                      ...
                      <div class="tournament__list-live">
                        <a href="https://www.twitch.tv/videos/1726788358" target="_blank">Live now
                  ...
                  <div class="tournament__list-item wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <div class="tournament__list-content">
                      <div class="tournament__list-thumb">
                        <a href="/">
                          <img src={tournament_thumb02} alt="img" />
                        </a>
                      </div>
                      <div class="tournament__list-name">
                  ...
                  <div class="tournament__list-item wow fadeInUp" data-wow-delay=".6s">
                    ...
                    <div class="tournament__list-content">
                      <div class="tournament__list-thumb">
                        <a href="tournament-details.html">
                          <img src={tournament_thumb03} alt="img" />
                        </a>
                      </div>
                      <div class="tournament__list-name">
